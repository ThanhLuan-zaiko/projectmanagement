        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-12 backdrop-blur-xl">
          <div className="flex flex-col items-center justify-center text-center">
            <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-blue-500/30">
              <FiClipboard className="w-10 h-10 text-white" />
            </div>
            <h1 className="text-3xl font-bold text-white mb-3">Task Board Management</h1>
            <p className="text-slate-400 mb-6 max-w-md">
              Manage and track all tasks in your project. Create, edit, and delete tasks with ease.
            </p>
