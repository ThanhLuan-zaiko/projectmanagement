...
export default function TablePagination({
  ...
  // Show pagination if alwaysShow is true OR there are multiple pages
      ...
      <div className="text-sm text-slate-400">
        {totalItems > 0 ? (
          <>
            ...
            <span className="text-white font-medium">{totalItems}</span> tasks
          </>
        ) : (
          <>
            Showing <span className="text-white font-medium">0</span> tasks
          </>
        )}
        {totalPages > 1 && (
          <>
